...
{
   char szReturn[51],szCmd[12];
   
   snprintf(szCmd,12,"SC %8s",sDate);
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: liblx200.c,v $ $Date: 2001/09/30 19:49:10 $ $Revision: 1.5 $ $Name:  $"};
