...
/* pop up a modal dialog to allow aborting a lengthy operation.
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: xmisc.c,v $ $Date: 2001/10/09 20:47:35 $ $Revision: 1.28 $ $Name:  $"};
