...
fs_create_fsshell()
{
	...
	XtManageChild (w);
	    ...
	    wtip (nettf_w, "URL from which to fetch GSC stars");
	    sr_reg (nettf_w, NULL, fscategory, 1);
	    ...
	    sr_reg (nettb_w, NULL, fscategory, 1);
	    ...
	    XtManageChild (etb_w);
	    sr_reg (etb_w, NULL, fscategory, 1);
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: fsmenu.c,v $ $Date: 2001/10/04 20:30:32 $ $Revision: 1.16 $ $Name:  $"};
