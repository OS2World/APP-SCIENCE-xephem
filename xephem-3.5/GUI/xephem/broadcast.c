...
extern void cc_cursor P_((Cursor c));
extern void cc_update P_((Now *np, int force));
...
extern void sc_cursor P_((Cursor c));
extern void se_cursor P_((Cursor c));
...
extern void si_cursor P_((Cursor c));
...
extern void wdb_cursor P_((Cursor c));
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: broadcast.c,v $ $Date: 2001/10/09 20:47:02 $ $Revision: 1.16 $ $Name:  $"};
