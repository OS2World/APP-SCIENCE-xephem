...
static void e_webupdate_cb P_((Widget w, XtPointer client, XtPointer call));
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: earthmenu.c,v $ $Date: 2001/10/10 05:33:17 $ $Revision: 1.49 $ $Name:  $"};
