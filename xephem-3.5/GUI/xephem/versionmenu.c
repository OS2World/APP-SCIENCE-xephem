...
static void drawPlanet P_((Display *dsp, Window win, GC gc, int sx, int sy,
    int w, int h));
static void v_define_gc P_((void));
...
COPYRIGHT,
"",
"- Permission is granted to use XEphem for personal use only. If you have",
"- source, you may modify it for your personal use but you may not distribute",
"- your changes nor use any portion (original or modified) in other programs.",
"- Contact the author to discuss commercial, classroom or other situations.",
"",
"- NO REPRESENTATION IS MADE ABOUT THE SUITABILITY OF THIS SOFTWARE FOR ANY",
"- PURPOSE. IT IS PROVIDED \"AS IS\" WITHOUT EXPRESS OR IMPLIED WARRANTY.",
"",
"- If you are using the free version, check out the CDROM version:",
"",
...
"",
"- Stay in touch with XEphem at http://www.ClearSkyInstitute.com/xephem.",
"",
"- Clear skies!",
"- Elwood Downey",
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: versionmenu.c,v $ $Date: 2001/10/16 01:40:11 $ $Revision: 1.22 $ $Name:  $"};
